    ...
    return (
        <div className="card">
            ...
            <div className="flex align-items-center justify-content-between mb-4">
                <div>
                    <h4 className="m-0 text-900 font-bold">Facturas</h4>
                    <span className="text-500 text-sm">Historial de facturas emitidas</span>
                </div>
            </div>
            ...
            {loading && facturas.length === 0 ? (
                ...
                >
                    ...
                    <Column header="Descuento" body={montoTemplate('Descuento Total')} sortable sortField="Descuento Total" style={{ minWidth: '130px' }} />
                    <Column field="IVA %" header="IVA %" style={{ minWidth: '80px' }} />
                    <Column header="IVA" body={montoTemplate('IVA')} style={{ minWidth: '120px' }} />
                    <Column header="Envío" body={montoTemplate('Costo Envío')} style={{ minWidth: '110px' }} />
